...
class Role(QWidget):
    ...
    def load_role_content(self, role_name=None, internal_window=None, back_callback=None):
        ...
        # If the role is "How to Create Your Own Role", use the display_create_role method if internal_window is available
    ...
    def display_create_your_own_role(self, back_callback=None):
        """
        Display the "How to Create Your Own Role" content with a Back button and scroll area
        similar to the ones in tweaks.py.
